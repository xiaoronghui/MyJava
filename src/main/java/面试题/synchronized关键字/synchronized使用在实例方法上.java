...
/**
* 用在实例方法上,其实就是获取当前实例的对象锁
*/
public class synchronized使用在实例方法上 {
	
	/**
	 * 验证 : synchronized 实例方法 表示任何一个线程执行到这的时候需要获取当前实例对象的锁(monitor),其它线程想获取该锁的,
	 * 被占用的情况下会被阻塞.
	 */
	@Test
